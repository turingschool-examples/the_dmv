...
#I want the key office_location[:address] = [:address_li] + [:address__1] + [:city] + [:state] + [:zip]

#I'm inside the enumerable, iterating each hash..
#look at specific key value pairs for address and return a concatenated string of them. 
