...
RSpec.describe AnalysisBot do
  ...
  xit "can produce the most common make and model" do
  ...
  it "can return number of cars for a given year" do
    expect(jeremy.cars_this_year(washington_vehicles, 2018)). to eq(157)
    expect(jeremy.cars_this_year(washington_vehicles, 2016)).to eq(82)
  end
end