...
RSpec.describe 'Analyize Data' do
  describe 'EV Registration' do
    ...
    describe '#most_popular_make_and_model' do
    ...
    describe '#registered_vehicle_by_year' do
  ...
  describe 'Facilities' do 
    ...
    describe '#daily_open_hours' do
      it 'finds daily hours for NY facilities' do
        new_york =  @facility.create_facility(@new_york_facilities)
        new_york_hours = new_york.first

        expect(new_york_hours.daily_open_hours).to eq([
