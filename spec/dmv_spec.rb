...
RSpec.describe Dmv do # rubocop:disable Metrics/BlockLength
  before(:each) do
    @dmv = Dmv.new
    @facility1 = Facility.new({ name: "DMV Tremont Branch",
                                address: "2855 Tremont Place Suite 118 Denver CO 80205", phone: "(720) 865-4600" })
    @facility2 = Facility.new({ name: "DMV Northeast Branch",
                                address: "4685 Peoria Street Suite 101 Denver CO 80239", phone: "(720) 865-4600" })
    @facility3 = Facility.new({ name: "DMV Northwest Branch",
                                address: "3698 W. 44th Avenue Denver CO 80211", phone: "(720) 865-4600" })
  end
