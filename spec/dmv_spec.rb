...
RSpec.describe Dmv do
  before(:each) do
    @dmv = Dmv.new
    @facility_1 = Facility.new('DMV Tremont Branch', '2855 Tremont Place Suite 118 Denver CO 80205', '(720) 865-4600')
    @facility_2 = Facility.new('DMV Northeast Branch', '4685 Peoria Street Suite 101 Denver CO 80239', '(720) 865-4600')
    @facility_3 = Facility.new('DMV Northwest Branch', '3698 W. 44th Avenue Denver CO 80211', '(720) 865-4600')
  end
