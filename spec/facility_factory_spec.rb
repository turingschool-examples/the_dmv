...
RSpec.describe FacilityFactory do 
  ...
  describe "#format_facility_address" do 
    it "formats CO facilities addresses" do 
      ...
      specific_co_facility_sample_1 = @colorado_facilities_data[1]
      expect(@colorado.format_facility_address(specific_co_facility_sample_1)).to eq("4685 Peoria Street Suite 101 Denver CO 80239")

      specific_co_facility_sample_2 = @colorado_facilities_data[2]
      expect(@colorado.format_facility_address(specific_co_facility_sample_2)).to eq("3698 W. 44th Avenue Denver CO 80211")
    end
  end
end