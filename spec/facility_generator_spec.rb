...
RSpec.describe FacilityGenerator do
    ...
    it "can generate an array of Facility objects from data input" do
        ...
        expect(generator.create_facilities(ny_dmv_office_locations)[0]).to be_instance_of(Facility)
        expect(generator.create_facilities(mo_dmv_office_locations)[0]).to be_instance_of(Facility)
    end
