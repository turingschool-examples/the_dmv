...
RSpec.describe Facility do
  ...
  describe '#registered_vehicles' do
    xit 'can keep a list of registered vehicles' do
  ...
  describe "#register_vehicle()" do
    it "will update registration" do
      ...
      expect(@facility_1.register_vehicle(@cruz)).to eq(@r_vehicles)
      expect(@cruz.registration_date).to eq(Date.today)
      expect(@cruz.plate_type).to eq(:regular)
      expect(@facility_1.registered_vehicles).to eq([@cruz])
      expect(@facility_1.collected_fees).to eq(100)
      
      expect(@facility_1.register_vehicle(@camaro)).to eq(@r_vehicles)
      expect(@camaro.registration_date).to eq(Date.today)
      expect(@camaro.plate_type).to eq(:antique)
      
      expect(@facility_1.register_vehicle(@bolt)).to eq(@r_vehicles)
  ...
  describe "#written test" do
    xit "administers written tests to applicants over 16" do
  ...
  describe "#Administer Road Test" do
    xit "allows registrants to earn a license" do
  ...
  describe "#renew Drivers License" do
    xit "Allows registrants to renew their license" do
      @facility_1.add_service('Written Test')
      @facility_1.add_service('Road Test')
      @facility_1.administer_written_test(@registrant_1)
      @registrant_2.earn_permit
