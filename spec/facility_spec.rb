...
RSpec.describe Facility do
  ...
  describe '#register vehicles' do
    ...
    it 'cannot register a vehicle that is already registered at another facility' do
      @facility_1.register_vehicle(@bolt)
      expect(@bolt.registration_date).to eq(Date.today)
      expect(@bolt.plate_type).to eq(:ev)
  ...
  describe '#administer tests' do
    ...
    it 'cannot administer a written test for underage registrants to earn a license' do
    ...
    it 'cannot administer a road test to an underage registrant' do
