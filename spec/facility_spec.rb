...
RSpec.describe Facility do
  ...
  describe "#initialize" do
    it "can initialize a facility" do
    ...
    it "can initialize a different facility" do
  ...
  describe "#determine_plate_type" do
    it "can determine type of plate to assign to vehicle" do
      expect(@facility_1.determine_plate_type(@cruz)).to eq(:regular)
      expect(@facility_1.determine_plate_type(@bolt)).to eq(:ev)
      expect(@facility_1.determine_plate_type(@camaro)).to eq(:antique)
    end
  end
  ...
  describe "#renew_drivers_license" do
    ...
    it "will renew drivers license only if service is offered" do
    ...
    it "will not renew drivers license if registrant is not licensed" do
