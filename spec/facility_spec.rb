...
RSpec.describe Facility do
  ...
  describe '#add service' do
    it 'can add available services for facility_1' do
      expect(@facility_1.services).to eq([])
  ...
  describe '#vehicle tests' do 
    it 'checks vehicle registration' do 
  ...
  describe '#DMV functions' do 
    it 'checks if facility can register properly and collect fees' do 
  ...
  describe '#Renew License' do 
    it 'can let registrants renew their license' do 
