...
RSpec.describe Facility do
  ...
  describe "#register_vehicle" do
    ...
    it "errors out if facility does not offer vehicle registration" do
      expect(@facility.register_vehicle(@cruz)).to eq("Error: DMV Tremont Branch does not offer Vehicle Registration services.")
    end
  end
  ...
  describe "#administer_written_test" do
    ...
    it "errors out if facility does not offer written tests" do
      registrant = Registrant.new("Chrysanthemum", 16, true)

      expect(@facility.administer_written_test(registrant)).to eq("Error: DMV Tremont Branch does not offer Written Test services.")
    end
  end
  ...
  describe "#administer_road_test" do
    ...
    it "errors out if facility does not offer road tests" do
      registrant_1 = Registrant.new("Bruce", 18, true)

      expect(@facility.administer_road_test(registrant_1)).to eq("Error: DMV Tremont Branch does not offer Road Test services.")
    end
  end
  ...
  describe "#renew_drivers_license" do
    ...
    it "errors out if facility does not offer license renewals" do
      registrant_1 = Registrant.new("Bruce", 18, true)

      expect(@facility.renew_drivers_license(registrant_1)).to eq("Error: DMV Tremont Branch does not offer License Renewal services.")
    end
  end
end
