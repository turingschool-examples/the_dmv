...
RSpec.describe Facility do
  ...
  describe "#administer_road_test" do
    it "can't administer a road test until that service is offered" do
      @facility_1.add_service("Written Test")
      @registrant_2.earn_permit
    ...
    it "can only administer the road test to eligible registrants" do
      @facility_1.add_service("Written Test")
      @registrant_2.earn_permit
      @facility_1.administer_written_test(@registrant_1)
      @facility_1.administer_written_test(@registrant_2)
  ...
  describe "#renew_drivers_license" do
    it "can't renew a license until that service is offerec" do
      @facility_1.add_service("Written Test")
      @facility_1.add_service("Road Test")
      @registrant_2.earn_permit
      @facility_1.administer_written_test(@registrant_1)
    ...
    it "can only renew the license of eligible registrants" do
      @facility_1.add_service("Written Test")
      @facility_1.add_service("Road Test")
      @registrant_2.earn_permit
      @facility_1.administer_written_test(@registrant_1)
