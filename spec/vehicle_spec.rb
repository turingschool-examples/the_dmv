...
RSpec.describe Vehicle do
  before(:each) do
    @acility_1 = Facility.new({name: 'DMV Tremont Branch', address: '2855 Tremont Place Suite 118 Denver CO 80205', phone: '(720) 865-4600'})
  ...
  describe '#plate_type' do
    it 'can determine if a vehicles plate type' do
